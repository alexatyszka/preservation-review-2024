...
setwd("~")
sra <- read.csv(file ="~/../../scratch/alexa/pres_rev_figs/01_data/03_cleaned_coords_for_maps/coords_sradb.csv")
...
cells_sra_2 <- count(cells_sra, scrubbed_species_binomial, h3_resolution_2, sort = TRUE) 
